...
$("#editPostModal").on("show.bs.modal", (event) => {
    ...
    $.get("/api/posts/" + postId, results => {
        outputEditPost(results.postData, $("#originalEditPostContainer"));
    })
})
...
$("#editPostButton").click((event) => {
    var content = {content: $("#editContent").val()};
...
function createPostHtml(postData, largeFont = false) {
    ...
    var sharedByBy = isShare ? postData.postedBy.username : null;
    ...
    if(isShare) {
        shareText = `<span>
                        ...
                        Shared by <a href='/profile/${sharedByBy}'>@${sharedByBy}</a>    
                    </span>`
    }
...
function createEditPostHtml(postData, largeFont = false) {
    ...
    return `<div class='editPost ${largeFontClass}' data-id='${postData._id}'>
                <div class='mainContentContainer'>
                    <div class='userImageContainer'>
                        <img src='${postedBy.profilePic}'>
                    </div>
                    <div class='postContentContainer'>
                        ...
                        <div class='textareaContainer'>
                            <textarea id='editContent'>${postData.content}</textarea>
                        </div>
                    </div>
                </div>
            </div>`;
...
function outputEditPost(results, container) {
    container.html("");
    ...
    results.forEach(result => {
        var html = createEditPostHtml(result)
        container.append(html);
    });
